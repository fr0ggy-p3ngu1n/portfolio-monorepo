...
const SKILLS: { category: string; icon: string; description: string; items: string[] }[] = [
  {
    ...
    items: ['Python', 'JavaScript', 'TypeScript', 'C / C++', 'Java', 'APEX', 'SQL / SOQL'],
  },
  {
    category: 'Web & Frameworks',
    icon: '🌐',
    description: 'Full-stack web experience from React SPAs and Angular enterprise apps on the frontend, to Hono and .NET on the backend. I lean toward TypeScript-first tooling and stay current with the modern ecosystem.',
    items: ['React', 'Hono', 'Angular', 'Tailwind CSS', 'Framer Motion', 'Django', '.NET', 'HTML / CSS'],
  },
  {
    category: 'Databases',
    icon: '🗄️',
    ...
    items: ['SQL', 'SOQL', 'MongoDB', 'D1 (SQLite)', 'Prisma', 'Pandas', 'NumPy'],
  },
  {
    category: 'Cloud & DevOps',
    icon: '☁️',
    description: 'Production experience deploying on Cloudflare\'s edge platform and familiarity with AWS. Version control is second nature across Git, GitHub, and GitLab, with CI/CD exposure through Bitbucket Pipelines and Ansible.',
    items: ['Cloudflare Workers', 'Cloudflare Pages', 'AWS', 'Git / GitHub / GitLab', 'Salesforce', 'JIRA', 'Ansible', 'pnpm'],
  },
  {
  ...
  },
  {
    ...
    items: ['PyTest', 'JUnit', 'Postman', 'TestRail', 'Gradle', 'Bitbucket'],
  },
  {
